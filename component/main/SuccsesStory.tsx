...
const SuccessStories = () => {
  ...
  const stories: Story[] = [
    ...
    },
    {
      ...
      title:
        "Don’t Just Study… Build Your Future 🚀 | Real Skills. Real Careers.",
      views: "34K",
    },
    {
      name: "Mayank Pandey",
      ...
      <div className="max-w-[1400px] mx-auto text-center relative z-10">
        ...
        <div className="mb-12 flex flex-col items-center text-center">
          ...
          <p className="text-slate-500 max-w-2xl text-center mt-4 text-md md:text-lg font-medium">
            Meet the talented individuals who have shaped their careers with
            Seamedu.
          </p>
        </div>
        ...
        <div
          ...
          className="flex overflow-x-auto gap-6 sm:gap-4 scrollbar-hide pb-10 pt-4 px-4"
          style={{
            scrollBehavior: "auto",
            scrollbarWidth: "none",
        ...
        >
          {duplicatedStories.map((story, index) => (
            <div
              ...
              className="relative group overflow-hidden rounded-2xl bg-black aspect-[2/3] cursor-pointer flex-none w-[260px] sm:w-[calc(25%-12px)] transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl"
            >
                ...
                <>
                  ...
                  <div className="absolute top-4 left-4 right-4 flex items-start space-x-2 z-20 pointer-events-none">
                    <div className="w-8 h-8 flex-shrink-0 bg-white rounded-full shadow-lg overflow-hidden border border-white/30">
                      <img
                        src="https://yt3.ggpht.com/4AiDGdFXrWFfvnoKnuxcjS5Lovn3JxiUbUvhCaTKkbDRk1JphjZ8FiKm9_JFuItnf_zXV3_s=s176-c-k-c0x00ffffff-no-rj-mo"
                        alt="Seamedu"
                        className="w-full h-full object-cover"
                      />
                    </div>
                    <div className="text-white text-left leading-tight drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)] overflow-hidden">
                      <p className="text-[11px] sm:text-xs font-bold line-clamp-2">
                        {story.title}
                      </p>
                      <p className="text-[9px] sm:text-[10px] opacity-90 mt-0.5">
                        Seamedu • {story.views} views
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10 scale-95 group-hover:scale-110 transition-transform duration-300">
                    <div className="drop-shadow-2xl">
                      ...
                      >
                        ...
                        <path
                          fill="#FFFFFF"
                          d="M9.544 14.502v-5.2l5.105 2.6z"
                        />
                      </svg>
                    </div>
                  </div>
